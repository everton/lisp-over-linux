...
/Booted under QEMU/OVMF: SBCL is PID 1, printing the supervisor menu on the
framebuffer console (Terminus 16x32 font, kernel tag #20)./
...
| [[file:background.org][background.org]]    | Background theory: UEFI handoff, x86 modes, USB-HID, multicore. |
| [[file:line-editing.org][line-editing.org]]  | Readline-class REPL editing in pure Lisp (implemented). |
