...
323 definitions deep, with the selected function's syntax-highlighted source
beside it./
...
locals. If a flat package list is the wrong way in, =l= at the supervisor menu
opens the *module index* instead — every definition grouped by the file it came
from.
